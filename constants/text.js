...
recommendPlace : ["ayutthaya"]}
  ...
  export const thResources = {  "app_title": "all new van team",
    "active_locale": "Thai",
    "description" : "รถตู้วีไอพีสำหรับรับ-ส่งสนามบินและต่างจัหวัดพร้อมบริการเช่าเหมาแบบรายวันสำหรับเที่ยวชมสถานที่ต่างๆทั้งในกรุงเทพฯและต่างจังหวัดทั่วไทยพร้อมคนขับมืออาชีพที่มีประสปการณ์ชำนาญเส้นทางและรู้จักแหล่งท่องเที่ยวที่น่าสนใจ ในราคายุติธรรมรับจองล่วงหน้าก่อนเดินทาง และพร้อมสำหรับการเรียกใช้เร่งด่วนภายใน 45นาที รถตู้รับจ้าง เช่ารถตู้ บริการรถตู้ เหมาไปต่างจังหวัดเช่าพร้อมคนขับ รับส่งสนามบิน เช่าเหมารถตู้ ครบวงจร และบริการอื่นๆเปิดให้บริการ 24 ชั่วโมง"}